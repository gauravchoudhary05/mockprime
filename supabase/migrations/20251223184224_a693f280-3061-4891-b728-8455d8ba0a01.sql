-- Fix the get_test_questions_without_answers function to dynamically detect column names
...
BEGIN
  ...
  RETURN QUERY EXECUTE format(
    'SELECT 
      ...
      CASE WHEN %L THEN 2::numeric ELSE COALESCE(t.%I, 1)::numeric END as marks,
      CASE WHEN %L THEN 0.25::numeric ELSE COALESCE(t.%I, 0.25)::numeric END as negative_marks
    FROM %I t
    ORDER BY t.%I ASC
    LIMIT 100',
    v_id_col,
...
-- Fix submit_test_answers function
...
-- Fix get_test_solutions function
